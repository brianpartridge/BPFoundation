...
#import "NSDictionary+BPFoundation.h"
#import "NSString+BPFoundation.h"

@implementation NSDictionary (BPFoundation)
...
- (NSString *)bp_queryStringForEntries {
    ...
    while ((key = [enumerator nextObject])) {
        ...
        if ([value isKindOfClass:[NSString class]]) {
            valueString = [(NSString *)value bp_urlEncodedString];
        ...
        if ([key isKindOfClass:[NSString class]]) {
            keyString = [(NSString *)key bp_urlEncodedString];
